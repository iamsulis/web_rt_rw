            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('login/logout') ?>" class="nav-link">Logout </span>
                    </ul></a>
                    </li>
                    <!-- Right navbar links -->
                    <ul class="navbar-nav ml-auto">
                        <span class="float-sm-right"> Welcome <?= session()->get('nama') . '-' . session()->get('jabatan') ?></span>
                    </ul>
                </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark"> Layanan RT RW </h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
